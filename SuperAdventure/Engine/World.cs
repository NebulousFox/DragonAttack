...
namespace Engine
{
    public static class World
    {
        ...
        {
            Location home = new Location(LOCATION_ID_HOME, "Home", "Your house. You really need to clena up the place.");
            ...
            Location farmersField = new Location(LOCATION_ID_FARM_FIELD, "Farmer's field", "You see rows of begetables growing here.");
            ...
            //Add the lcoations to the static list
            Locations.Add(home);
